return {
  {
    ...
    config = function()
      ...
      keyset('x', '<leader>cca', '<Plug>(coc-codeaction-selected)', opts)
      keyset('n', '<leader>cca', '<Plug>(coc-codeaction-selected)', opts)
      ...
      keyset('n', '<leader>ccq', '<Plug>(coc-fix-current)', opts)

      -- Remap keys for apply refactor code actions.
      keyset('n', '<leader>cre', '<Plug>(coc-codeaction-refactor)', { silent = true })
      keyset('x', '<leader>ccr', '<Plug>(coc-codeaction-refactor-selected)', { silent = true })
      keyset('n', '<leader>ccr', '<Plug>(coc-codeaction-refactor-selected)', { silent = true })
